...
Bomberboy.UserInput.prototype = Object.create(Phaser.Plugin.prototype);
Bomberboy.UserInput.prototype.constructor = Bomberboy.UserInput;
...
Bomberboy.UserInput.prototype.init = function (game_state, user_input_data) {
    ...
    this.game.input.keyboard.addCallbacks(this, this.process_input, this.process_input);
};
    ...
    if (this.user_inputs[event.type] && this.user_inputs[event.type][event.keyCode]) {
        ...
        if (user_input) {
            ...
            if (callback_data[0] === "game_state") {
                this.game_state[callback_data[1]].apply(this.game_state, user_input.args);
            } else {
                // identify prefab
